...
"""autogenerated by genpy from my_msg/sensor.msg. Do not edit."""
import codecs
import sys
...
class sensor(genpy.Message):
  _md5sum = "1543a1d8184d5550cc7560e6b4c63a88"
  _type = "my_msg/sensor"
...
float64 w
"""
  __slots__ = ['ids','size','pose','id','xacc','yacc','zacc','temperture']
  _slot_types = ['int32[]','float64[]','geometry_msgs/PoseWithCovarianceStamped','int8','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       ids,size,pose,id,xacc,yacc,zacc,temperture
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_b4f().pack(_x.id, _x.xacc, _x.yacc, _x.zacc, _x.temperture))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.xacc, _x.yacc, _x.zacc, _x.temperture,) = _get_struct_b4f().unpack(str[start:end])
      return self
