...
(cl:defmethod cl:initialize-instance :after ((m <detection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'detection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msg-msg:<detection> is deprecated: use my_msg-msg:detection instead.")))

(cl:ensure-generic-function 'ids-val :lambda-list '(m))
(cl:defmethod ids-val ((m <detection>))
...
(cl:defmethod size-val ((m <detection>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<detection>)))
  ...
  "6d599f8b285490e8cb57c49657b27f64")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'detection)))
  "Returns md5sum for a message object of type 'detection"
  "6d599f8b285490e8cb57c49657b27f64")
